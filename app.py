...
def chestScanPrediction(path,_model):
    model = tensorflow.keras.models.load_model(_model)
    # Loading Image
    ...
    # Getting Predictions
    pred = np.argmax(model.predict(input_arr_img)) # type: ignore
...
if uploaded_file is not None:
    ...
    chestScanPrediction(uploaded_file, 'best_model.keras')